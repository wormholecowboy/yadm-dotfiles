...
_G.packer_plugins = {
  ...
  ["blue-moon"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/blue-moon",
  ...
  ["vim-blackboard"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-blackboard",
  ...
  ["vim-solarized8"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-solarized8",
